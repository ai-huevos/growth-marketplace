...
### 2026-02-21 21:51 — 00-proyecto-overview.md (Edit)

- [ ] Doc-00 contains two conflicting versions in NLM: old (5 plugins, 17 skills) vs new (6 plugins, 29 skills). Delete stale NLM source to resolve.
- [ ] Doc-21 (`21-plugin-conversational-pm.md`) says conversational-pm has 0 commands, but doc-00 now lists 3 (`/os`, `/roadmap`, `/estado`). Update doc-21.
...
### 2026-02-21 23:51 — 27-rebrand-kai-partners.md (Edit)

- [ ] Stale data (outdated termi
- [ ] Stale data (deprecated refere
- [ ] Missi
- [ ] Missi
- [ ] Stale data (outdated cou


### 2026-02-22 00:03 — 27-rebrand-kai-partners.md (Edit)

- [ ] swer": "ISSUE: **Stale Data (Bra
- [ ] **Co
- [ ] **Missi
- [ ] **Termi
- [ ] **Missi
