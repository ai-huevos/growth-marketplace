...
> **Tier 1 BAIT de la escalera ESCALA de KAI Partners.**
...
Derivadas de `clients/kai-partners/brand-config/brand-voice.md`:
...
| Documento | Relacion |
|-----------|----------|
| `clients/kai-partners/offer-architecture/escala-value-ladder.md` | Este quiz es el Tier 1 (Bait) de la escalera ESCALA |
| `clients/kai-partners/sequences/secuencia-origen.md` | Secuencia de 5 emails activada post-quiz |
| `clients/kai-partners/case-studies/finkargo.md` | Datos de Finkargo usados en preguntas y resultados |
| `clients/kai-partners/brand-config/brand-voice.md` | Reglas de voz aplicadas a todo el copy |
| `clients/kai-partners/brand-config/acf-profile.md` | Personalidad de marca en paginas de resultado |
| `clients/kai-partners/brand-config/creation-myth.md` | "AI es como el sol" -- metafora central del quiz |
