...
2. `clients/kai-partners/pricing/pricing-grid.md` — pricing source of truth
3. `clients/kai-partners/brand-config/brand-reference.md` — brand rules
4. `clients/kai-partners/sales-engine/frameworks/html-deliverable-spec.md` — HTML spec
5. `clients/kai-partners/sales-engine/templates/discovery-report-html.md` — HTML template
...
**Template**: `clients/kai-partners/delivery/mapa-energia-template.md`
...
**Template**: `clients/kai-partners/delivery/propuesta-aios-build.md`
...
**Reference**: `clients/kai-partners/sales-decks/g3-logistica-board-deck.md` (Andy Raskin 5 Moves pattern)
