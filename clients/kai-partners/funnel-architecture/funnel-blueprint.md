...
cross-references:
  - clients/kai-partners/offer-architecture/escala-value-ladder.md
  - clients/kai-partners/sequences/secuencia-origen.md
  - clients/kai-partners/sequences/secuencia-pulsar.md
  - clients/kai-partners/case-studies/finkargo.md
  - clients/kai-partners/brand-config/brand-voice.md
  - clients/kai-partners/brand-config/acf-profile.md
  - clients/kai-partners/brand-config/creation-myth.md
---

# Arquitectura Maestra de Funnel — KAI Partners

> Este documento es el blueprint definitivo del sistema go-to-market de KAI Partners.
...
KAI Partners no vende AI. Construye el sistema operativo de la empresa con el cliente, usando sus datos, y se queda hasta que funciona.
...
> Referencia completa: `clients/kai-partners/offer-architecture/escala-value-ladder.md`
...
> Referencia de quiz detallada: `clients/kai-partners/quiz-funnel/` (por crear)
...
> Referencia de landing page detallada: `clients/kai-partners/website/` (por crear)
...
> Referencia completa: `clients/kai-partners/offer-architecture/escala-value-ladder.md` — Tier 2
...
> Referencia completa: `clients/kai-partners/sequences/secuencia-origen.md`
...
> Referencia completa: `clients/kai-partners/sequences/secuencia-pulsar.md`
...
> Datos completos en `clients/kai-partners/offer-architecture/escala-value-ladder.md` — Seccion 4
...
|---|--------|------|--------|-----------|-----------|
| A1 | Landing page (10 secciones) | Web | POR CREAR | `clients/kai-partners/website/` | A2, A3, A8 |
| A2 | Quiz: Diagnostico de Energia AI | Interactivo | POR CREAR | `clients/kai-partners/quiz-funnel/` | -- |
| A3 | Caso Finkargo (web version) | Caso | LAUNCH-READY | `clients/kai-partners/case-studies/finkargo.md` | -- |
| A4 | Secuencia ORIGEN (5 emails) | Email | DRAFT | `clients/kai-partners/sequences/secuencia-origen.md` | A9, A10 |
| A5 | Secuencia PULSAR (calendario) | Email | DRAFT | `clients/kai-partners/sequences/secuencia-pulsar.md` | A4 |
| A6 | Secuencia Re-engagement (3 emails) | Email | POR CREAR | -- | A4, A5 |
| A7 | ESCALA Value Ladder | Estrategia | DRAFT | `clients/kai-partners/offer-architecture/escala-value-ladder.md` | -- |
| A8 | Brand Voice | Guia | IN-REBRAND | `clients/kai-partners/brand-config/brand-voice.md` | -- |
| A9 | ACF Profile | Guia | DRAFT | `clients/kai-partners/brand-config/acf-profile.md` | -- |
| A10 | Creation Myth | Narrativa | DRAFT | `clients/kai-partners/brand-config/creation-myth.md` | -- |
...
| A18 | Funnel Blueprint (este documento) | Estrategia | DRAFT | `clients/kai-partners/funnel-architecture/funnel-blueprint.md` | -- |
...
> Referencia completa: `clients/kai-partners/case-studies/finkargo.md`
