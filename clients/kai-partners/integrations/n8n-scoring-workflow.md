...
```javascript
// ============================================================
// KAI Partners — Energy Score + PULSO Calculator
// Implements 7-step scoring algorithm from quiz spec
// Source: clients/kai-partners/quiz-funnel/diagnostico-energia-ai.md
// ============================================================
...
`clients/kai-partners/integrations/n8n-workflows/`
...
`clients/kai-partners/quiz-funnel/diagnostico-energia-ai.md` → "Cálculo Paso a Paso"
