...
cross-references:
  ...
  - clients/kai-partners/funnel-architecture/funnel-blueprint.md
  - clients/kai-partners/brand-config/brand-voice.md
  - clients/kai-partners/case-studies/finkargo.md
```

> Este documento es el runbook operativo del Sprint de Descubrimiento — el producto Frontend de KAI Partners ($500-$1,500).
...
KAI Partners — AI-OS Built with you. Proven with your data.
```
...
- [ ] Branding KAI Partners consistente en todo el documento
...
4. **Equipo asignado** (2-3 KAI Partners, nombres si es posible)
