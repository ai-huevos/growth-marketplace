...
## Entregable del Sprint de Descubrimiento — KAI Partners
...
|----------|---------|----------:|
| AI-OS Build (90 días) | {{NUM_KAI_PARTNERS}} KAI Partners embebidos, {{HORAS_ESTIMADAS}} horas totales | ${{INVERSION_BUILD}} |
...
| 2 | Firma de acuerdo y kick-off | KAI Partners + {{NOMBRE_EMPRESA}} | {{FECHA_KICKOFF}} |
