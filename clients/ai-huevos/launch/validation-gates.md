# Validation Gates — AI Huevos Launch
...
**Archivo de referencia:** `clients/ai-huevos/brand-config/brand-voice.md`
...
**Archivo de referencia:** `clients/ai-huevos/case-studies/finkargo.md`
...
**Archivo de referencia:** `clients/ai-huevos/offer-architecture/escala-value-ladder.md`
...
- [ ] Crear `clients/ai-huevos/voc/prospect-language-bank.md` ✅ (creado)
