...
Sistema de orquestacion de ventas full-cycle para AI Huevos. Encadena skills del marketplace + MCPs en un pipeline repetible con entregables de marca.
...
- Full brand reference: `clients/ai-huevos/brand-config/brand-reference.md`

## Deal Storage Convention

```
clients/ai-huevos/deals/<company-slug>/
