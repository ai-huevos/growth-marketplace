...
`clients/ai-huevos/sales-engine/frameworks/transcript-extraction.md`
...
Usar el template en `clients/ai-huevos/sales-engine/templates/business-context.md` y reemplazar todos los `{{PLACEHOLDER}}` con datos extraidos del transcript.

Guardar en: `clients/ai-huevos/deals/<company-slug>/business-context.md`
...
- El opportunity sizing debe referenciar `clients/ai-huevos/pricing/pricing-grid.md`

### Paso 3: Auto-trigger Coaching

Despues de la extraccion, ejecutar automaticamente el analisis de coaching:
`clients/ai-huevos/sales-engine/commands/sales-coach.md`
...
`clients/ai-huevos/voc/prospect-language-bank.md`
