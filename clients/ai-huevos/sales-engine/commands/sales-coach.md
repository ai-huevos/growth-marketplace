...
1. Buscar en `clients/ai-huevos/deals/<company-slug>/business-context.md` para contexto
2. Obtener el transcript via Fireflies MCP o pedir que lo peguen

### Paso 2: Analisis por Dimension

Leer el scorecard framework:
`clients/ai-huevos/sales-engine/frameworks/conversation-quality-scorecard.md`
...
Guardar en: `clients/ai-huevos/deals/<company-slug>/coaching-report.md`
