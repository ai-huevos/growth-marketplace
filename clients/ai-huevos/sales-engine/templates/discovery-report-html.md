...
spec: clients/ai-huevos/sales-engine/frameworks/html-deliverable-spec.md
---
...
> Save output to: `clients/ai-huevos/deals/<company-slug>/discovery-report.html`
...
<body>
  ...
  <header class="header">
    ...
    <div class="meta">
      {{CALL_DATE}} &middot; {{CALL_DURATION}} min &middot; Prepared by AI Huevos
    </div>
  </header>
  ...
  <footer class="footer">
    ...
    <p>AI Huevos &mdash; Nos quedamos.</p>
...
1. Read `clients/ai-huevos/deals/<company-slug>/business-context.md`
...
6. Save the complete HTML to `clients/ai-huevos/deals/<company-slug>/discovery-report.html`
