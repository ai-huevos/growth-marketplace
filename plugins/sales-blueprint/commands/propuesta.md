---
description: Genera una propuesta comercial B2B basada en el diagnostico PULSO del deal. Incluye business case, ROI, y Mutual Action Plan.
...
### Fase 1: Recopilar PULSO del Deal

Preguntar al usuario por el diagnostico PULSO. Si no lo tiene, ayudarlo a construirlo:

1. **Panorama**: "Cuentame sobre el prospect: industria, tamano, herramientas actuales, contexto reciente."
2. **Urgencia**: "Cual es el dolor principal? Hay numeros? (ej: cuanto tiempo/dinero pierden)"
3. **Logro**: "Si resuelven esto, que cambia? (numeros + impacto personal para el decision maker)"
4. **Situación Crítica**: "Hay un deadline? Que pasa si no actuan a tiempo?"
5. **Organización**: "Quien firma? Como es el proceso? Que criterios usan para evaluar?"

**Esperar las respuestas. Sintetizar antes de continuar.**

Calcular el PULSO score. Si es < 23, advertir al usuario:

> "El PULSO score es [X]/30. Para una propuesta solida, recomiendo primero completar el diagnostico en las dimensiones [X, Y]. Quieres proceder de todas formas o prefieres hacer mas discovery?"
...
2. **Entendimiento de su Situacion**: Basado en P+U del PULSO. Demostrar que entendiste su mundo.
3. **Costo de la inaccion**: Basado en S (Situación Crítica). Que pasa si no actuan.
...
8. **Criterios de evaluacion**: Como la solucion cumple cada criterio de Organización del PULSO.
9. **Proximos pasos**: Mutual Action Plan con timeline atado a la SC.
...
- [ ] Cada seccion refleja datos especificos del PULSO (no generico)
