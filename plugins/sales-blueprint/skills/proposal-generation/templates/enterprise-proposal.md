...
**Preparado para**: [Nombre del Decision Maker], [Titulo]
**Preparado por**: [Nombre del AE], [Titulo]
**Fecha**: [Fecha]
...
*Cada componente conectado con un dolor especifico. No features — outcomes.*

### Vision de la solucion
[1-2 oraciones describiendo el estado futuro deseado]
...
### Quick Wins (Primeros 30 dias)
- [Resultado rapido 1 con metrica]
- [Resultado rapido 2 con metrica]

### Resultados a 90 dias
- [Resultado mediano plazo 1]
- [Resultado mediano plazo 2]

### Resultados a 12 meses
- [Resultado sostenido 1]
- [Resultado sostenido 2]

### Metricas de exito

| KPI | Baseline actual | Target a 90 dias | Target a 12 meses |
|-----|----------------|-------------------|-------------------|
| [Metrica 1] | [Valor actual] | [Target] | [Target] |
| [Metrica 2] | [Valor actual] | [Target] | [Target] |
| [Metrica 3] | [Valor actual] | [Target] | [Target] |
...
- [Deliverable 1]
- [Deliverable 2]
- Milestone: [Que se logra al final de esta fase]

**Fase 2: Build (Semanas 5-8)**
- [Deliverable 3]
- [Deliverable 4]
- Milestone: [Que se logra]

**Fase 3: Launch (Semanas 9-12)**
- [Deliverable 5]
- [Deliverable 6]
- Milestone: [Go-live + primeros resultados]

**Fase 4: Optimize (Semanas 13-16)**
- [Iteracion basada en datos]
- [Optimizacion]
- Milestone: [Resultados sostenidos validados]

### Roles y Responsabilidades

| Rol | Nosotros | [EMPRESA] |
|-----|---------|-----------|
...
|--------|-------------|---------|------------|
| [Riesgo 1] | Media | Alto | [Plan de mitigacion] |
| [Riesgo 2] | Baja | Medio | [Plan de mitigacion] |
...
|---|----------|-------------|-----------|
| [Componente 1] | Incluido | Incluido | Incluido |
| [Componente 2] | — | Incluido | Incluido |
| [Componente 3] | — | — | Incluido |
...
```
Costo del problema actual:        $___/ano
Inversion en la solucion:         $___/ano
Ahorro neto anual:                $___/ano
ROI:                              ___x
...
|----------------------------------|-------------------|-----------|
| [Criterio 1 del prospect] | [Como] | [Caso/dato/demo] |
| [Criterio 2 del prospect] | [Como] | [Caso/dato/demo] |
| [Criterio 3 del prospect] | [Como] | [Caso/dato/demo] |

---

## 7. Seguridad y Compliance

- Certificaciones: [SOC2, ISO 27001, etc.]
- Data residency: [Ubicacion de datos]
- Encryption: [At rest + in transit]
- Auditorias: [Frecuencia]
- DPA/GDPR: [Disponible para revision]

---

## 8. Proximos Pasos

Mutual Action Plan para implementar antes de [CRITICAL EVENT]:

| Paso | Owner | Fecha |
|------|-------|-------|
| Revision de propuesta con equipo | [Champion] | [Fecha] |
| Sesion de Q&A tecnica | [Nosotros + Users] | [Fecha] |
| Business case review con [DM] | [Champion + Nosotros] | [Fecha] |
| Revision de contrato (Legal) | [Legal de ambos lados] | [Fecha] |
| Firma | [Decision Maker] | [Fecha] |
| Kickoff de implementacion | [Ambos equipos] | [Fecha] |

**Esta propuesta es valida hasta [Fecha].** Despues de esta fecha, los terminos estan sujetos a revision dado [razon conectada con disponibilidad/recursos/pricing].

---

*Contacto: [Nombre del AE] | [Email] | [Telefono]*
