...
4. Cuando se deben cumplir los hitos
5. Como se mide el exito
...
|-----------|-------------|---------|
| **WHAT (Meta)** | Que queremos lograr — debe ser medible | Reducir defectos de codigo en 30% |
| **WHO (Responsable)** | Quien es responsable de cada lado | Equipo de desarrollo del cliente + CSM |
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│ META: Reducir defectos de codigo en __% dentro del equipo Development   │
│                                                                         │
│ WHAT: Alcanzar _% de reduccion en defectos                             │
│ WHO:  Equipo Development (cliente) + CSM (nosotros)                    │
│ WHEN: Dentro de 1 mes del primer escaneo                               │
│ HOW:  - Dirigir usuarios a recursos educativos de auto-servicio        │
│       - Conducir webinars mensuales para impulsar engagement           │
│       - Revisar metricas de progreso semanalmente                      │
└──────────────────────────────────────────────────────────────────────────┘
```
...
HOY      30 DIAS        60 DIAS        90-180 DIAS      6 MOS       9 MOS       1 ANO
 ...
 ▼          ▼              ▼               ▼              ▼           ▼           ▼
┌──────┐ ┌──────────┐ ┌──────────┐ ┌───────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐
│Setup │ │First     │ │Training  │ │Monthly    │ │Monthly   │ │Monthly   │ │Monthly   │
│Account│ │Project   │ │Completed │ │Report,    │ │Report,   │ │Report,   │ │Report    │
│Sched.│ │Completed │ │          │ │CSM        │ │CSM       │ │AM        │ │          │
│Train.│ │          │ │          │ │Check-In   │ │Check-In  │ │Check-In  │ │          │
└──────┘ └──────────┘ └──────────┘ └───────────┘ └──────────┘ └──────────┘ └──────────┘

CLIENTE:  Project Lead   First Project   Project Lead    Lunch 'n
          Identified     Completed       Learn

METRICAS: First Project  25% Usage       50% Usage       70% Usage    70% Usage
...
- **First Value**: El momento donde el producto entrega valor tangible por primera vez

**Fase Ongoing** — el journey de 12 meses completo:
- **12-Month Goal**: Como se ve el exito al final de 12 meses?
- Metas definidas separadamente para onboarding y ongoing

### Responsabilidades por Timeline

| Periodo | Responsabilidad del Cliente | Nuestra Responsabilidad | Key Metrics |
|---------|---------------------------|------------------------|-------------|
| **Inicio** | Project Lead identificado | Setup cuenta, agendar training | First Project Identified |
| **30 dias** | Primer proyecto completado | Training completado | 25% Usage |
| **60 dias** | Team Lunch 'n Learn | Monthly Report | 50% Usage |
| **90-180 dias** | Adopcion comprensiva | Monthly Report, CSM Check-In | 70% Usage |
| **6 meses** | Utilizacion comprensiva del equipo | Monthly Report, Training Refresher | 70% Usage |
...
1. **Preparar 1-2 historias relevantes** de clientes (de exito Y de fracasos/errores)
2. **Preparar best practices** de clientes exitosos en la misma etapa
3. **Pre-poblar el Impact Plan** con action items y metas del cliente que ya conoces
4. **Preparar sugerencias de impacto** que pueden lograr dentro de un periodo especifico

### Durante la reunion:

1. **Compartir best practices** de clientes exitosos
2. **Compartir errores comunes** de clientes no exitosos
3. **Proveer lista corta de action items** inmediatos
4. **Establecer metas inmediatas Y de largo plazo** con timeframes especificos (30, 60, 90 dias, 6 meses, 9 meses, 1 ano)
5. **Colaborar** en el documento — que sea customer-facing

### Ejercicio Individual para Preparacion:

1. Escribe el nombre de un cliente particularmente exitoso y uno no exitoso
2. Piensa en al menos 3 cosas concretas que cada uno hizo diferente
...
AFTER COMMIT    WITHIN 3 MONTHS    6-8 MONTHS       9-10 MONTHS
     │                │                 │                  │
     ▼                ▼                 ▼                  ▼
  KICKOFF        FIRST VALUE       FULL VALUE        RENEWAL CALL
     │                │                 │                  │
     │                │                 │                  │
   COMMIT           ───────────────  RENEWAL  ───────────────
                                        │
...
### Usar metas especificas al definir key metrics:

**DEBIL**: "Mejorar el uso de la plataforma"
**FUERTE**: "Alcanzar 70% de uso activo del equipo de desarrollo dentro de 60 dias"

**DEBIL**: "Reducir costos"
**FUERTE**: "Reducir costos operativos en $50K anuales al eliminar 3 herramientas redundantes antes del Q3"

### Metas preparadas vs metas colaborativas:

- **Llegar preparado** con sugerencias de impacto que otros clientes han logrado en la misma etapa
- **Colaborar** con el cliente para personalizar las metas a su contexto
- **Incluir tanto metas del onboarding como del ongoing** — definir por separado
