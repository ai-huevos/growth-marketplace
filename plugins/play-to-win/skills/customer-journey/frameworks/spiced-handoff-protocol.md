...
**Que capturar**:
- Industria y vertical especifica
- Tamano de empresa (empleados, revenue)
- Tech stack relevante (CRM, herramientas clave)
- Rol y titulo del contacto principal
- Estructura del equipo comprador
- Etapa de madurez en el area de impacto

**Estandarizacion de terminologia**:

| Termino informal | Termino estandarizado |
|-----------------|----------------------|
| "Empresa grande" | "Enterprise, 2,000+ empleados, $500M+ revenue" |
| "Recien empezando" | "Early-stage, Serie A, 30 empleados, product-market fit en validacion" |
| "Industria tech" | "SaaS B2B, vertical fintech, mercado LATAM" |
...
**Que capturar**:
- Dolor #1 con cita textual del cliente
- Dolor #2 y #3 priorizados con contexto
- Quien sufre cada dolor (persona, equipo, departamento)
- Desde cuando existe el dolor
- Que han intentado para resolverlo

**Preguntas contextuales vs genericas**:

| Pregunta generica (EVITAR) | Pregunta con contexto (USAR) |
|---------------------------|------------------------------|
| "¿Cuales son tus principales desafios?" | "Jon menciono que los reps no siguen un proceso estandarizado. ¿Sigue siendo la prioridad principal?" |
| "¿Que problemas tienes?" | "Entendemos que perdieron 3 deals enterprise el trimestre pasado por falta de executive sponsorship. ¿Pudiste avanzar algo en ese frente?" |
| "¿Con que luchas dia a dia?" | "Tu equipo menciono que pasan 40% del tiempo en tareas administrativas en lugar de vender. ¿Eso ha cambiado?" |
| "¿Que te gustaria mejorar?" | "Sabemos que el onboarding de nuevos reps toma 9 meses actualmente. ¿Siguen con ese timeline?" |
...
PAIN (priorizado):
  ...
  #2: [Segundo dolor] — "[Cita textual]"
  #3: [Tercer dolor] — "[Cita textual]"
```
...
IMPACT:
  ...
  Emocional: [Motivacion personal del champion]
    Ejemplo: "VP Sales en riesgo si no muestra mejora antes del board review de marzo"
```
...
CRITICAL EVENT:
  ...
  Ejemplo: "Board review 15/03. Si no muestran mejora en pipeline velocity, cortaran equipo de 12 a 8 reps"
```
...
- Mapear criterios de evaluacion explicitos e implicitos
- Identificar campeon, bloqueador, y decisor economico
- Timeline del proceso de compra con gates

**Para deals high-velocity (SMB/mid-market)**:
- Documentar proceso de compra (pasos, aprobaciones)
- Identificar decisor principal y posibles bloqueadores
- Timeline es suficiente — criterios detallados son innecesarios

**Formato de documentacion**:

```
DECISION:
  Proceso: [Pasos de compra: eval → piloto → comite → firma]
  Personas: [Decisor: CFO | Champion: VP Sales | Bloqueador: IT Director]
  Criterios: [ROI en 6 meses, integracion con HubSpot, soporte en espanol]
  Timeline: [Eval completada para Feb, decision en comite Mar 1, firma Mar 15]
```

---

## Completar el Handoff Interno

### Pre-handoff: Preparacion
...
- [ ] Red flags o temas sensibles a evitar
...
### During: La Reunion Interna

La reunion interna es OBLIGATORIA antes de la primera interaccion con el cliente. Su duracion varia:

| Tipo de deal | Duracion | Formato |
|-------------|----------|---------|
| High-velocity (SMB) | 90 segundos - 5 minutos | Standup rapido o mensaje asincrono |
| Mid-market | 15 minutos | Videollamada estructurada |
...
5. Definir canal de comunicacion para dudas post-traspaso

---

### Post-handoff: Seguimiento

El traspaso no termina cuando el equipo receptor toma el control. Hay un periodo de transicion donde ambos equipos mantienen visibilidad.

- **Primeras 48 horas**: Primera interaccion con el cliente. Usar preguntas con contexto.
- **Primera semana**: Actualizacion al equipo anterior sobre como fue la primera interaccion
- **Primer mes**: Cerrar loop — confirmar que el traspaso fue exitoso o identificar gaps
...
- Pain principal articulado (idealmente con cita textual)
- Como se genero el interes (inbound/outbound, que contenido consumio)
- Disponibilidad y preferencias de comunicacion

**Errores comunes**:
- Pasar solo "esta interesado" sin contexto de pain
- No documentar como se genero el lead (el AE pierde contexto de messaging)
- Agendar reuniones sin confirmar que hay pain real
...
- Promesas hechas durante el proceso de venta (documentadas)
- Red flags identificados durante la negociacion
...
- Health score actual y tendencia
- Nuevos stakeholders identificados durante la relacion
- Areas donde el cliente ha mostrado interes de expansion
- Riesgos identificados (adoption baja, cambio de champion, budget freeze)
- Historial de QBRs con temas recurrentes

**Errores comunes**:
- Pasar al AM cuando hay red flags sin resolver
- No documentar resultados logrados (el AM necesita prueba de valor para expandir)
- Omitir cambios en stakeholders (el mapa de poder puede haber cambiado)
