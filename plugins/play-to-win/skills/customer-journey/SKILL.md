...
## Filosofia: El cliente no distingue entre tus departamentos

El cliente vive UNA experiencia continua. No le importa si habla con ventas, customer success, o account management — espera que cada persona que lo atienda conozca su contexto, entienda su dolor, y continue donde el anterior dejo. Cada vez que un cliente tiene que repetir su historia, se erosiona la confianza que tanto costo construir.
...
│          │                    │                    │                 │
│          ▼                    ▼                    ▼                 │
│   Traspasos sin        Excelencia en       Criterios de            │
│   friccion             cada punto de       entrada/salida          │
│   SDR→AE→CSM→AM       contacto            por etapa               │
└─────────────────────────────────────────────────────────────────────┘
```
...
**Preguntas con contexto (correcto)**:
- "Jon menciono que el equipo de ventas no sigue un proceso estandarizado... ¿sigue siendo la prioridad principal?"
- "Entiendo que tienen un board review en marzo donde necesitan mostrar mejora. ¿Como vamos con ese timeline?"

**Preguntas genericas (incorrecto)**:
...
## Pilar 2: Los 7 Momentos Clave (Metodo de Ventas SaaS)

El Metodo de Ventas SaaS redefine cada interaccion con el cliente. No son "pasos de venta" — son momentos donde la mentalidad del vendedor determina si la relacion se fortalece o se deteriora.

### Los 7 reframes que cambian todo

| # | Momento Clave | Mentalidad Vieja | Mentalidad Nueva |
|---|--------------|------------------|------------------|
| **M1** | Resultados de Negocio | ¿Este prospect es buen fit? | ¿Que resultado de negocio podemos generar? |
| **M2** | Conversacion | Calificar al prospect (BANT) | Tener una conversacion real sobre su negocio |
| **M3** | Diagnosticar | Hacer el pitch lo antes posible | Diagnosticar antes de prescribir — siempre |
| **M4** | Tradear | Negociar (ambos pierden algo) | Tradear (intercambiar valor equivalente) |
| **M5** | Orquestar | Onboardear (lanzar y rezar) | Orquestar milestones y guiar la relacion |
| **M6** | Resultados | Medir uso del producto | Medir resultados de negocio del cliente |
| **M7** | Crecer | Upsell (vender mas territorio) | Crecer impacto positivo (expansion natural) |

### Estados emocionales del cliente en cada etapa

```
Awareness    Education    Selection    Onboard      Use          Expand
   😫            💡           🤩          🤠          ⭐           🤯
 "Aargh!"     "Aha!"      "Wow!"    "Yeehaw!"   "Awesome!"    "OMG!"
   │            │            │           │            │            │
   ▼            ▼            ▼           ▼            ▼            ▼
  Dolor      Esperanza   Conviccion  Entusiasmo  Resultados   Expansion
 reconocido  de solucion  de compra   de inicio   tangibles    proactiva
```
...
### M4 en profundidad: Tradear vs Negociar

| Negociar (evitar) | Tradear (adoptar) |
|-------------------|-------------------|
| "Te hago 15% de descuento" | "Puedo ajustar el precio si firmamos este mes y pagamos anual" |
| El valor del deal se reduce | El valor del deal se mantiene |
| El cliente aprende a pedir descuento | El cliente entiende que hay intercambio |
| Menu de opciones: nulo | Menu de trades: 5-8 opciones preparadas |

> Para el framework completo del Metodo de Ventas SaaS con ejercicios, ver `frameworks/saas-sales-method.md`.

---

## Pilar 3: Diseno de Etapas del Journey

Cada etapa del journey debe tener criterios claros de entrada, acciones definidas, y criterios de salida. Sin esto, los deals se estancan en etapas incorrectas y el forecast se vuelve ficcion.

### Mapa de etapas con criterios
...
| **Expand** | OMG! | Impacto demostrado | Identificar nuevos pains, nuevas areas | Expansion cerrada o referencia generada | M7 |

### El shift de BANT a Impact

| BANT (Tradicional) | Impact (SaaS) | Por que el cambio |
|--------------------|---------------|-------------------|
| **B**udget: ¿Tienes presupuesto? | **P**riority: ¿Es prioridad para el negocio? | Si es prioridad, el presupuesto aparece |
| **A**uthority: ¿Eres el decisor? | **C**onsensus: ¿Quien mas necesita alinearse? | Las decisiones B2B son por consenso, no por jerarquia |
| **N**eed: ¿Necesitas esto? | **I**mpact: ¿Que impacto tendra en tu negocio? | Need es binario; Impact es cuantificable |
| **T**imeline: ¿Para cuando? (trimestres) | **A**nytime: ¿Que cambia si lo haces ahora vs despues? | El timeline surge del Critical Event, no del calendario fiscal |

---

## El Impacto Compuesto de Mejoras Incrementales

Pequenas mejoras en cada etapa del journey generan un impacto exponencial en ARR. Este ejercicio demuestra por que optimizar TODO el journey importa mas que obsesionarse con una sola metrica.

### Ejercicio: Calculadora de impacto compuesto

| Metrica | Team -2 | Team -1 | Tu Equipo | Team +1 | Team +2 |
|---------|---------|---------|-----------|---------|---------|
| ACV | $___ | $___ | $___ | $___ | $___ |
| CR1 (Awareness → Education) | ___% | ___% | ___% | ___% | ___% |
| CR2 (Education → Selection) | ___% | ___% | ___% | ___% | ___% |
| Win Rate (Selection → Close) | ___% | ___% | ___% | ___% | ___% |
| Descuento promedio | ___% | ___% | ___% | ___% | ___% |
| ARR resultante | $___ | $___ | $___ | $___ | $___ |

### Preguntas para la discusion

1. ¿Que pasa si mejoras CADA tasa de conversion solo 5%? ¿Cual es el impacto compuesto en ARR?
2. ¿Donde esta tu cuello de botella actual? ¿En que etapa pierdes mas oportunidades?
3. Si solo pudieras mejorar UNA metrica, ¿cual generaria el mayor impacto en revenue?

> **Insight clave**: Mejorar cada CR en solo 2-3 puntos porcentuales puede duplicar el ARR resultante. El impacto no es aditivo — es multiplicativo.

---

## Conexion con otros skills

| Skill | Relacion con Customer Journey |
|-------|-------------------------------|
| `sales-transformation` | El customer journey es la Fase 3 del roadmap de transformacion de 90 dias |
| `deal-strategy` | Los Momentos Clave M3 y M4 alimentan directamente la estrategia de deals |
| `pre-discovery-research` | La investigacion pre-discovery prepara el M2 (Conversacion, no Calificacion) |
| `relationship-mapping` | El mapeo 3x3 es critico para M4 (Decision: mapear stakeholders y criterios) |
| `customer-success-ops` | M5-M7 son el dominio directo de CS: Orquestar, Resultados, Crecer |
| `renewal-expansion` | M7 (Crecer, no Upsell) define la filosofia de expansion y renovacion |
