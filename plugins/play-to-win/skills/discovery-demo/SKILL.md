...
- Quiere dominar los 4 tipos de preguntas (cerrada, cerrada con contexto, abierta, abierta con contexto)

## Filosofia: Prescripcion sin diagnostico es malpractice
...
## Los 3 Pilares de Discovery & Demo

```
┌─────────────────────────────────────────────────────────────────────┐
│                    DISCOVERY & DEMO SYSTEM                          │
│                                                                     │
│  ┌──────────────────┐  ┌──────────────────┐  ┌──────────────────┐  │
...
| Paso | Nombre | Accion | Tiempo |
|------|--------|--------|--------|
| **A** | Appreciate | Agradecer el tiempo del prospect | 10 seg |
| **C** | Check End Time | Confirmar hora de cierre | 10 seg |
| **E** | End Goal | Establecer el objetivo de la reunion | 25 seg |

### Post-ACE: La Pregunta Poderosa

Despues de ACE, confirmar la agenda y luego preguntar:

> "Que mas quisieras obtener de la reunion de hoy?"

Esta pregunta aparentemente simple es tremendamente poderosa: transfiere ownership al prospect, revela prioridades ocultas, y establece un contrato psicologico de valor mutuo.
...
|------|--------|-----------|
| 1 | Open | Abrir la reunion con ACE |
| 2 | ACE | Ejecutar Appreciate-Check-End Goal |
| 3 | Agenda | Confirmar agenda + pregunta poderosa |
| 4 | Wagon | Conectar esta reunion con la anterior |
| 5 | Connect | Establecer puente a la siguiente reunion |
| 6 | Set Goal + Secure | Objetivo siguiente + confirmar asistencia |

Multi-threading: Siempre invitar mas stakeholders a la siguiente reunion para expandir el mapa de relaciones.
...
1. **Open** — Abrir con energia y profesionalismo
...
| Tipo | Ejemplo | Efecto |
|------|---------|--------|
| Cerrada simple | "Tienes equipo de marketing?" | Informacion basica |
| Cerrada + contexto | "Vi en LinkedIn que tienes 12 personas en Marketing... es correcto?" | Demuestra preparacion |
| Abierta simple | "Como se comunican entre equipos?" | Abre la conversacion |
| Abierta + contexto | "Jennifer menciono que usan CRM X... como lo ha aprovechado el equipo?" | Profundiza con credibilidad |

### Tecnica de Resumen

> "Entonces tienes [Situacion 1] y [Situacion 2] que te causan [Pain]... capte bien?"

Este resumen logra 3 cosas: valida comprension, demuestra escucha activa, y abre la puerta para profundizar o corregir.
...
### Estructura: Un Dolor a la Vez

Cada demo point sigue la misma estructura (5-7 minutos cada uno):

1. **Mostrar solucion** — Demostrar como se resuelve el dolor especifico
2. **Compartir historia** — Use-case de un cliente similar
3. **Preguntar impacto** — "Te ves usando esto?", "Como impactaria...?"

### Preguntas de Impacto Durante Demo
...
## Discovery → Demo Progression

La informacion fluye como una cascada desde el primer contacto hasta el cierre del demo:
...
└─────────────────────────────────────────┘
        ...
        ▼
┌─ Diagnosis Deep-Dive ──────────────────┐
│  Preguntas con contexto profundizan    │
│  Resumen valida comprension            │
│  Historia de terceros construye trust  │
└─────────────────────────────────────────┘
        │
        ▼
┌─ Demo & Prescribe ─────────────────────┐
│  "Antes compartiste que..." (conexion) │
│  Demo Point 1 ←── Dolor 1 validado    │
│  Demo Point 2 ←── Dolor 2 validado    │
│  Demo Point 3 ←── Dolor 3 validado    │
│  Decision Criteria ←── Impact Qs      │
└─────────────────────────────────────────┘
```

**Regla fundamental**: Nunca demostrar algo que no se haya diagnosticado primero. Si el prospect no reconocio el dolor, el demo point no tiene fundamento.
